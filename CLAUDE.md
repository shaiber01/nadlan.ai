...
- Errors a check is meant to catch belong in `tests/fixtures/scenario.ts` (`installScenario()`), never in the seed: the seeded project is correct data, and the tests inject what they need on top of it.
