...
Next: phase 4 (`get_monitor_settings` / `set_monitor_settings` tools so the bot can switch itself, the launchd plist, the docs pass), and the user's Vonage setup (§13, phase 2) for the first real message.
