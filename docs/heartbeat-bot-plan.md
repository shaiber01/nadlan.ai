...
Next: phase 3 (the alerts over WhatsApp with the heartbeat on: the pass in the shared conversation on the real channel, the quiet one-liner, the report link).
