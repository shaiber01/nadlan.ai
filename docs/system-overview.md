...
| תיקיית מסמכים | See every document with its processing status; upload a real file (PDF, image, text) with kind, title, date, supplier, the record it belongs to, uploader | — (the document row records the uploader) |
