...
interface ChapterSpec {
  ...
  nameHe: string;
  sectionId: SectionId;
  /** description, quantity, unit, unit price in ₪ before VAT — the priced BOQ of a lump-sum contract sums to the contract; where no contract is signed yet, to the (rounded) budget */
  lines: [string, number, string, number][];
  coverageRefOverride?: string;
}

const CHAPTERS: ChapterSpec[] = [
  { chapter: "01", nameHe: "עבודות עפר", sectionId: "04", lines: [["חפירה כללית בכל סוגי הקרקע", 9_800, "מ״ק", 42], ["חפירת תעלות ליסודות", 1_200, "מ״ק", 70], ["מילוי מובא מהודק", 2_600, "מ״ק", 98], ["פינוי עודפי עפר", 7_200, "מ״ק", 55], ["הידוק שתית", 3_100, "מ״ר", 9], ["דיפון זמני", 620, "מ״ר", 480]] },
  { chapter: "02", nameHe: "בטון יצוק באתר", sectionId: "02", lines: [["בטון רזה", 210, "מ״ק", 550], ["רפסודת יסוד ב-30", 1_150, "מ״ק", 950], ["קירות תת-קרקעיים ב-30", 640, "מ״ק", 1_250], ["עמודים ב-30", 380, "מ״ק", 1_650], ["קורות ב-30", 520, "מ״ק", 1_450], ["תקרות ב-30 עובי 22 ס״מ", 2_980, "מ״ק", 1_320], ["מדרגות", 96, "מ״ק", 2_400], ["קירות ממ״ד ב-30", 410, "מ״ק", 1_450], ["מוטות פלדה מצולעים לזיון", 750, "טון", 4_000], ["רשתות פלדה מרותכות", 38, "טון", 4_000], ["טפסות לקירות", 9_100, "מ״ר", 195], ["טפסות לתקרות", 13_500, "מ״ר", 175], ["איטום פני בטון בתת-קרקע", 3_100, "מ״ר", 45], ["הכנות לפתחים ושרוולים", 1, "קומפ׳", 176_000]] },
  { chapter: "04", nameHe: "בנייה", sectionId: "06", lines: [["בנייה בבלוקי בטון 20 ס״מ", 6_400, "מ״ר", 82], ["בנייה בבלוקי בטון 10 ס״מ", 4_100, "מ״ר", 60], ["בנייה בבלוקי איטונג 15 ס״מ", 2_200, "מ״ר", 95], ["חגורות ועמודונים", 210, "מ״ק", 900], ["משקופים סמויים", 480, "יח׳", 120], ["ארגזי תריסים", 190, "יח׳", 220]] },
  { chapter: "05", nameHe: "איטום", sectionId: "05", lines: [["איטום יסודות ביריעות ביטומניות", 3_100, "מ״ר", 85], ["איטום קירות תת-קרקעיים", 2_400, "מ״ר", 75], ["איטום גגות", 1_350, "מ״ר", 125], ["איטום חדרים רטובים", 1_450, "מ״ר", 71], ["איטום מרפסות", 960, "מ״ר", 80], ["איטום קירות חניון", 1_800, "מ״ר", 60]] },
  { chapter: "06", nameHe: "נגרות ומסגרות", sectionId: "13", lines: [["דלתות כניסה לדירות", 48, "יח׳", 4_800], ["דלתות פנים", 336, "יח׳", 1_750], ["מעקות מתכת למדרגות", 420, "מ׳", 650], ["מעקות מרפסות (מסגרות)", 380, "מ׳", 780], ["דלתות אש לחניון", 22, "יח׳", 5_600], ["ארונות חשמל ותקשורת", 48, "יח׳", 2_200], ["סולמות ופתחי גישה", 12, "יח׳", 3_200], ["שערים לחדרי מכונות", 6, "יח׳", 7_500]] },
  { chapter: "07", nameHe: "תברואה", sectionId: "08", lines: [["צנרת מים קרים וחמים", 4_800, "מ׳", 110], ["צנרת דלוחין וביוב פנימית", 3_900, "מ׳", 125], ["כלים סניטריים", 192, "יח׳", 2_900], ["מערכת הגברת לחץ", 2, "קומפ׳", 65_000], ["צנרת גז", 1_100, "מ׳", 120], ["מערכת סולארית", 48, "יח׳", 7_200], ["ניקוז מזגנים", 1_400, "מ׳", 60], ["שרוולים תת-קרקעיים", 1, "קומפ׳", 36_100]] },
  { chapter: "08", nameHe: "חשמל", sectionId: "09", lines: [["לוחות חשמל דירתיים", 48, "יח׳", 5_200], ["לוח חשמל ראשי", 2, "יח׳", 120_000], ["נקודות מאור", 3_360, "יח׳", 240], ["נקודות כוח", 2_880, "יח׳", 250], ["תשתיות תקשורת", 48, "יח׳", 4_500], ["הארקת יסוד", 2, "קומפ׳", 38_950], ["תאורת חירום ושילוט", 210, "יח׳", 650], ["אינטרקום", 48, "יח׳", 3_200]] },
  { chapter: "09", nameHe: "טיח", sectionId: "06", lines: [["טיח פנים", 14_800, "מ״ר", 37], ["טיח חוץ", 6_300, "מ״ר", 66], ["טיח תרמי", 1_200, "מ״ר", 113], ["פינות מגן", 4_100, "מ׳", 8]] },
  { chapter: "10", nameHe: "ריצוף וחיפוי", sectionId: "12", lines: [["ריצוף גרניט פורצלן 60/60", 4_900, "מ״ר", 205], ["ריצוף חדרים רטובים", 1_450, "מ״ר", 190], ["חיפוי קירות חדרים רטובים", 3_100, "מ״ר", 195], ["ריצוף מרפסות", 960, "מ״ר", 180], ["ריצוף לובי וחדרי מדרגות", 620, "מ״ר", 320], ["שיש למטבחים", 48, "יח׳", 4_500], ["פנלים", 5_400, "מ׳", 22], ["ריצוף חניון (החלקת בטון)", 2_400, "מ״ר", 45]] },
  { chapter: "11", nameHe: "צבע", sectionId: "15", lines: [["צבע פנים על טיח", 14_800, "מ״ר", 18], ["צבע חוץ", 6_300, "מ״ר", 30], ["צבע על גבס", 5_100, "מ״ר", 16], ["צביעת מסגרות", 620, "מ״ר", 40]] },
  { chapter: "12", nameHe: "אלומיניום", sectionId: "11", lines: [["חלונות הזזה", 288, "יח׳", 2_575], ["ויטרינות סלון", 48, "יח׳", 9_500], ["תריסי גלילה", 288, "יח׳", 1_400], ["מעקות זכוכית למרפסות", 380, "מ׳", 750], ["דלתות כניסה ללובי", 4, "יח׳", 17_750], ["רפפות למערכות", 96, "יח׳", 450]] },
  { chapter: "15", nameHe: "מיזוג אוויר", sectionId: "10", lines: [["מזגנים מיני-מרכזיים דירתיים", 48, "יח׳", 14_500], ["תעלות אוויר", 2_300, "מ׳", 159], ["צנרת גז מיזוג", 1_900, "מ׳", 93], ["מפזרי אוויר", 480, "יח׳", 270], ["בקרה ותרמוסטטים", 48, "יח׳", 1_100], ["אוורור חדרים רטובים", 144, "יח׳", 550]] },
  { chapter: "17", nameHe: "מעליות", sectionId: "14", lines: [["מעלית נוסעים 8 תחנות", 4, "יח׳", 305_000], ["הרצה ואישור מכון התקנים", 4, "קומפ׳", 20_000]] },
  { chapter: "22", nameHe: "גבס", sectionId: "15", lines: [["תקרות גבס", 3_800, "מ״ר", 75], ["קירות גבס", 1_300, "מ״ר", 100], ["סינרי גבס", 2_100, "מ׳", 55], ["פתחי גישה", 96, "יח׳", 100]] },
  { chapter: "23", nameHe: "כלונסאות", sectionId: "04", lines: [["כלונסאות קדוחים קוטר 60", 1_450, "מ׳", 450], ["כלונסאות קדוחים קוטר 80", 620, "מ׳", 640], ["ראשי כלונסאות", 96, "יח׳", 2_775], ["בדיקות סוניות", 96, "יח׳", 650]] },
  { chapter: "34", nameHe: "גילוי וכיבוי אש", sectionId: "16", lines: [["מערכת ספרינקלרים לחניון", 2_400, "מ״ר", 165], ["גלאי עשן ולוח בקרה", 1, "קומפ׳", 240_000], ["עמדות כיבוי", 14, "יח׳", 5_000], ["מערכת שחרור עשן", 1, "קומפ׳", 320_000]] },
  { chapter: "40", nameHe: "פיתוח האתר", sectionId: "07", lines: [["קירות תומכים מבטון", 210, "מ״ק", 2_100], ["ריצוף אבן משתלבת", 1_650, "מ״ר", 240], ["גינון והשקיה", 1, "קומפ׳", 520_000], ["גדר היקפית", 240, "מ׳", 850], ["תאורת חוץ", 32, "יח׳", 9_500], ["ריהוט גן", 1, "קומפ׳", 100_000], ["מדרגות חוץ", 42, "מ׳", 1_800], ["רמפות לחניון", 2, "קומפ׳", 150_000]] },
  { chapter: "44", nameHe: "שערים ומחסומים", sectionId: "16", lines: [["שער חניון חשמלי", 2, "יח׳", 55_000], ["מחסום זרוע", 2, "יח׳", 32_000]] },
  { chapter: "51", nameHe: "סלילה", sectionId: "07", lines: [["מצע סוג א׳", 1_100, "מ״ק", 165], ["אספלט לחניה עילית", 1_300, "מ״ר", 145], ["אבני שפה", 420, "מ׳", 110], ["סימון וצביעה", 1, "קומפ׳", 34_500]] },
  { chapter: "57", nameHe: "קווי מים, ביוב וניקוז", sectionId: "07", lines: [["צינור מים פוליאתילן 110 מ״מ, כולל חפירה ומילוי", 140, "מ׳", 380], ["קו ביוב PVC SN8 200 מ״מ בתחום המגרש", 95, "מ׳", 620], ["שוחות בקרה לביוב קוטר 100 ס״מ", 6, "יח׳", 5_500], ["קווי ניקוז פנימיים PVC 250 מ״מ", 60, "מ׳", 560], ["צינור ניקוז PVC קשיח SN8 קוטר 400 מ״מ, כולל חפירה, מצע ומילוי, עומק עד 2.5 מ׳", 80, "מ׳", 1_500], ["מחבר לתשתית עירונית כולל קידוח ואטימה", 1, "קומפ׳", 110_000]] },
];
...
export function buildBoq(): HBoqLine[] {
  ...
  for (const ch of CHAPTERS) {
    ...
    ch.lines.forEach(([descriptionHe, qty, unit, unitPrice], i) => {
      ...
      lines.push({ id, chapter: ch.chapter, chapterNameHe: ch.nameHe, descriptionHe, qty, unit, unitPrice, sectionId, coverage, coverageRef, coveredByContractId: coveredBy, noteHe });
    });
  }
  return lines;
}
