...
export const hadarimDocuments: HDocument[] = [
  ...
  build("boq_v5_ch57", "boq_page", "כתב כמויות גרסה 5 (2.9.2026) — פרק 57: קווי מים, ביוב וניקוז — עדכון", "2026-09-02", null, "boq_v5_ch57.pdf", [
    ...
    { kind: "highlight", text: "עדכון מול גרסה 4: סעיף 57.03.040 (קו ניקוז חוץ Ø400, קו ראשי עד נקודת החיבור העירונית) הוצא מהיקף שלב זה — יועבר לשלב ב׳ של הפיתוח בהמתנה להחלטת תכנון.", anchor: "removed" },
