...
export const hadarimDocuments: HDocument[] = [
  ...
  build("contract_07_01_excerpt", "contract_excerpt", "חוזה קבלנות משנה 07-01 — נ.ת.ב. תשתיות ופיתוח — עמ׳ 3–4, סעיף 3 היקף העבודות", "2026-01-05", "SUP-NTB", "contract_07-01_excerpt.pdf", [
    ...
    { kind: "highlight", text: "3.4 העבודות שאינן כלולות: לא כולל קווי ניקוז ראשיים מחוץ לקו הבניין ועד נקודת החיבור לתשתית העירונית; לא כולל אגרות חיבור לתאגיד המים; לא כולל עבודות סלילה ברשות הרבים.", anchor: "exclusion" },
  ...
  build("boq_v4_ch57", "boq_page", "כתב כמויות גרסה 4 (12.8.2026) — פרק 57: קווי מים, ביוב וניקוז", "2026-08-12", null, "boq_v4_ch57.pdf", [
    { kind: "heading", text: "כתב כמויות לביצוע — הדרים · גרסה 4 · 12.8.2026 · פרק 57 — קווי מים, ביוב וניקוז" },
    {
      ...
      rows: [
        ["סעיף", "תיאור", "יח׳", "כמות"],
        ["57.01.010", "צינור מים פוליאתילן 110 מ״מ, כולל חפירה ומילוי", "מ׳", "140"],
        ["57.02.020", "קו ביוב PVC SN8 200 מ״מ בתחום המגרש", "מ׳", "95"],
        ["57.02.030", "שוחות בקרה לביוב קוטר 100 ס״מ", "יח׳", "6"],
        ["57.03.030", "קווי ניקוז פנימיים PVC 250 מ״מ", "מ׳", "60"],
        ["57.03.040", "צינור ניקוז PVC קשיח SN8 קוטר 400 מ״מ, כולל חפירה, מצע ומילוי, עומק עד 2.5 מ׳ — קו ראשי עד נקודת החיבור העירונית", "מ׳", "80"],
        ["57.04.010", "מחבר לתשתית עירונית כולל קידוח ואטימה", "קומפ׳", "1"],
      ],
    },
    { kind: "highlight", text: "57.03.040 — קו ניקוז חוץ Ø400 — 80 מ׳ — הערה: קו ראשי עד נקודת החיבור העירונית", anchor: "line" },
